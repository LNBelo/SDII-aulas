...
module toplevel (
    ...
    localparam DATA_WIDTH = 32; // A Palavra tem 32 bits
    localparam ADDR_WIDTH = 14; // O endereçamento é feito em Bytes. São 14 Bytes em 4095
            ...
            case (state)
                ...
                WRITE: begin
                    ...
                    if (wb_ack_i) begin
                        ...
                        current_src_adr <= current_src_adr + 3'd4;
                        current_dst_adr <= current_dst_adr + 3'd4;
