...
module toplevel (
    ...
    localparam DATA_WIDTH = 32; // palavras de 32b, Largura dos dados (32 bits)
    localparam ADDR_WIDTH = 14; // Largura do Endereço (4096 = 2^14 BITS)
    ...
    dma #(
        ...
        .ADD_SOURCE(14'h0000), // ROM
        .ADD_DESTIN(14'h3C00), // RAM
        .WORDS(1024)
    ) dma (
        .clk_i(clk_i),
        .rst_i(rst_i),
